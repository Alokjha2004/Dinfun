...
$(document).ready(function(){
  ...
  $(".share-menu").on("click","a",function(){
    ...
    if(type == "whatsapp"){
      var url = "https://api.whatsapp.com/send?text=Check+out+CSS+Diner%20http%3A%2F%2Fcssdiner.com";
    } else if (type == "facebook") {
      var url = "https://www.facebook.com/sharer.php?src=sp&u=http%3A%2F%2Fcssdiner.com";
    } else if(type=="instagram"){
      var url = "https://www.instagram.com/p/Br48W66nV17/?taken-by=flukeout";
    } else if (type == "email") {
